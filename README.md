...
* Set <span>$</span>applicationFilePath to the path from "c$\" of the application you want to get the version of (Copy as Path) (Make sure to remove everything before and including "c$\" or "C:\")
